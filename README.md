# Apache Airflow Docker (default v3.8) with Non-Root User setup
* A standalone docker of Apache Airflow
...
```
./run.sh    (interactive command console mode)
./run.sh -d (daemon mode)
or,
make up
```
...
# (optional) Build/Run Container Inside Corporate Proxy or Networks
